...
var nrpns = [
	...
	{ name: "JOYSTICK ASSIGN (+)", nrpn: 0x22, min: 0, max: 28, randomize: false, interface: true, enum: inputAssignEnum },
	{ name: "JOYSTICK RANGE (+)", nrpn: 0x23, min: 0, max: 200, randomize: false, interface: true, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "JOYSTICK ASSIGN (-)", nrpn: 0x24, min: 0, max: 28, randomize: false, interface: true, enum: inputAssignEnum },
	{ name: "JOYSTICK RANGE (-)", nrpn: 0x25, min: 0, max: 200, randomize: false, interface: true, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "CV IN MODE", nrpn: 0x28, min: 0, max: 2, randomize: false, interface: true, enum: [
			"Modulation", "CV/Gate(+)", "CV/Gate(-)"
		] 
	},
	{ name: "CV IN 1 ASSIGN", nrpn: 0x29, min: 0, max: 28, randomize: false, interface: true, enum: inputAssignEnum },
	{ name: "CV IN 1 RANGE", nrpn: 0x2A, min: 0, max: 200, randomize: false, interface: true, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "CV IN 2 ASSIGN", nrpn: 0x2B, min: 0, max: 28, randomize: false, interface: true, enum: inputAssignEnum },
	{ name: "CV IN 2 RANGE", nrpn: 0x2C, min: 0, max: 200, randomize: false, interface: true, uiRange: { min: -100, max: 100 }, uiCentered: true },
	...
	{ name: "SCALE KEY", nrpn: 0x31, min: 0, max: 24, randomize: false, interface: true, uiRange: { min: -12, max: 12 }, uiCentered: true },
	{ name: "PROGRAM TUNING", nrpn: 0x32, min: 0, max: 100, uiRange: { min: -50, max: 50 }, uiCentered: true },
	{ name: "LFO KEY SYNC", nrpn: 0x34, min: 0, max: 1, enum: [ "OFF", "ON" ] },
	{ name: "LFO VOICE SYNC", nrpn: 0x35, min: 0, max: 1, enum: [ "OFF", "ON" ] },
	{ name: "LFO TARGET OSC", nrpn: 0x36, min: 0, max: 3, enum: [ "All", "VCO1+2", "VCO2", "Multi" ] },
	...
	{ name: "EG LEGATO", nrpn: 0x3C, min: 0, max: 1, enum: [ "OFF", "ON" ] },
	{ name: "PORTAMENTO MODE", nrpn: 0x3D, min: 0, max: 1, enum: [ "Auto", "On" ] },
	{ name: "PORTAMENTO BPM SYNC", nrpn: 0x3E, min: 0, max: 1, enum: [ "OFF", "ON" ] },
	{ name: "PROGRAM LEVEL", nrpn: 0x3F, min: 0, max: 120, randomize: false },
	{ name: "VPM PARAM 1 (Feedback)", nrpn: 0x40, min: 0, max: 200, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "VPM PARAM 2 (Noise Depth)", nrpn: 0x41, min: 0, max: 200, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "VPM PARAM 3 (Shape Mod Int)", nrpn: 0x42, min: 0, max: 200, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "VPM PARAM 4 (Mod Attack)", nrpn: 0x43, min: 0, max: 200, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "VPM PARAM 5 (Mod Decay)", nrpn: 0x44, min: 0, max: 200, uiRange: { min: -100, max: 100 }, uiCentered: true },
	{ name: "VPM PARAM 6 (Mod Key Track)", nrpn: 0x45, min: 0, max: 200, uiRange: { min: -100, max: 100 }, uiCentered: true },
...
function postProcess() {
	for (var n in nrpns) {
		...
		nn.setValueFromView = utils.setValueFromView;
		nn.getValueForView = utils.getValueForView;
	}
}
